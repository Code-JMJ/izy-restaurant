...
class RoleSeeder extends Seeder
{
    ...
    {
        $rol_super_admin = Role::create(['name' => 'Super Admin', 'guard_name'=>'web', 'description_key' => 'superadmin']);
        $rol_admin = Role::create(['name' => 'Admin', 'guard_name'=>'web', 'description_key' => 'admin']);
        $rol_customersupport = Role::create(['name' => 'Customer Support', 'guard_name'=>'web', 'description_key' => 'customersupport']);
        ...
        $permissionGroupCompany = PermissionGroup::create(['name' => 'Management Company', 'description_key' => 'management_company']);
        ...
        $permission_view_company = Permission::create(['name' => 'view company', 'description_key' => 'view_company', 'permission_group_id'=>$permissionGroupCompany->id]);
        $permission_edit_company = Permission::create(['name' => 'edit company', 'description_key' => 'edit_company', 'permission_group_id'=>$permissionGroupCompany->id]);
        ...
        $permission_product_report = Permission::create(['name' => 'products report', 'description_key' => 'products_report', 'permission_group_id'=>$permissionGroupReport->id]);
        ...
        $permission_admin = [
            ...
            $permission_view_company, $permission_edit_company,
            $permission_sale_report, $permission_product_report
        ];
